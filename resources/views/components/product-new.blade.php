...
<div class="container mx-auto py-10">
      <h1 class="text-3xl font-extrabold text-center text-white py-4 px-6 rounded-3xl shadow-xl mb-12 tracking-wider bg-gradient-to-r from-pink-500 via-yellow-300 to-purple-500 animate-pulse">
