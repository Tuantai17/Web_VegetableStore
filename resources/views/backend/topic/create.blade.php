            ...
            <div class="border border-blue-100 mb-3 rounded-lg p-2">
                <div class="flex items-center justify-between">
                    ...
                    <div class="text-right">
                        <button type="submit" class="bg-green-500 px-4 py-2 cursor-pointer rounded-xl mx-1 text-white">
                            <i class="fa fa-save"></i> Lưu
                        </button>
                        <a href="{{ route('topic.index') }}" class="bg-sky-500 px-4 py-2 rounded-xl mx-1 text-white">
