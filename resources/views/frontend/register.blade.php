<x-layout-site>
    ...
    <main class="max-w-md mx-auto mt-10">
        ...
        <form method="POST" enctype="multipart/form-data"
            ...
            <input type="text" name="phone" placeholder="Số điện thoại" class="w-full p-2 border rounded" required>
            <input type="text" name="address" placeholder="Địa chỉ" class="w-full p-2 border rounded" required>
